...
public class PostGenerateToken {
    ...
    //Token(-)
    @Step("I request POST generate token with invalid password")
    public void requestPOSTGenerateTokenInvalid () {
        JSONObject requestData = new JSONObject();
        requestData.put("userName", "hakim0015");
    ...
    @Step("validate the data detail after generate token failed with invalid password")
    public void validate_DataDetail_GenerateTokenFailed_InvalidPassword () {
        then().body("code", equalTo(null));
    }

    @Step("I request POST generate token with empty password")
    public void requestPOSTGenerateTokenEmpty () {
        JSONObject requestData = new JSONObject();
        requestData.put("userName", "hakim0015");
    ...
    @Step("validate the data detail after generate token failed with empty password")
